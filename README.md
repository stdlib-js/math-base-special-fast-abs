...
```javascript
import abs from 'https://cdn.jsdelivr.net/gh/stdlib-js/math-base-special-fast-abs@v0.3.1-esm/index.mjs';
```
...
[test-image]: https://github.com/stdlib-js/math-base-special-fast-abs/actions/workflows/test.yml/badge.svg?branch=v0.3.1
[test-url]: https://github.com/stdlib-js/math-base-special-fast-abs/actions/workflows/test.yml?query=branch:v0.3.1
